...
class FOR3X_SIGNAL:
    ...
    def get_message(self, chName):
        ...
        try:
            result=self.driver.find_elements_by_xpath("//div[@class='im_history_messages_peer']//div[@class='im_history_message_wrap']//div[@class='im_message_text']")[-1]
            sleep(2)
    ...
    def createSignalDto(self,msg,chName):
        ...
        signalDto.type = 1 if enter[1] == "BUY" else 2
