    ...
    def get_message(self, chName):
        ...
        try:
            ...
            try:
                ...
                result4 = self.driver.find_elements_by_xpath("//div[contains(@class,'im_history_messages_peer') and not(contains(@class,'ng-hide'))]//div[contains(@class,'im_history_message_wrap') and not(@style='display: none;')]//div[contains(@class,'im_message_media')]//div[@class='im_message_photo_caption' and not(@style='display: none;')]")[-1].text
                results.append([result3,-1])
                results.append([result3,-2])
            except:
                print(sys.exc_info()[0])
