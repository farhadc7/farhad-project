...
class BotEngine:
    ...
    recentSignals={'forexsignalzz':0,'amirFX_signal':0,'FOR3X_SIGNAL':0,'AmirFx VIP signal':0,'Eagl777':0 , 'WallstreetFXsignals':0, 'wolfofforexplus':0, 'light_forex':0,'WSSignals':0}
    signalVendors={'a':  1}
    utils = Utils() 
    fileUtil = FileUtil()
    ...
    def setListOfVendors(self):
        ...
        self.signalVendors['light_forex']=[forexsignalzz(self.driver),'light_forex']
        self.signalVendors['WSSignals']=[forexsignalzz(self.driver),'WSSignals']
