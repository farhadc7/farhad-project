...
class SendSignalService(DWX_ZMQ_Strategy):
        ...
        while self._market_open:
            ...
            try:
                ...
                for i in _ot.index:
                    ...
                    if abs((Timedelta((to_datetime('now') + Timedelta(self._broker_gmt, 'h')) - to_datetime(
                            _ot.at[i, '_open_time'])).total_seconds())) > self._close_t_delta:
