...
from providers.pipstowin import pipstowin
from providers.forexsignalfactory import forexsignalfactory
import logging
...
class BotEngine:
    ...
    def setListOfVendors(self):
        ...
        self.signalVendors['pipstowin'] = [pipstowin(self.driver), 'tp sl']
        self.signalVendors['forexsignalfactory'] = [forexsignalfactory(self.driver), 'sl tp']
